"""
Site A — DBLP Node
FastAPI service cung cấp dữ liệu từ site_a.db
Port: 8001
"""
...
DB_PATH = os.environ.get("DB_PATH", "./data/site_a.db")
SITE_ID = "site_a"
...
def get_candidates(
    ...
    """
    Trả về danh sách papers/authors theo blocking key.
    Coordinator gọi endpoint này ở cả 2 site để lấy candidates trước khi tính similarity.
    """
    filters, params = [], []
    if year:
...
def get_document(paper_id: str):
    ...
    Bao gồm unstructured data: abstract, keywords, metadata mở rộng.
